...
@Injectable({
  providedIn: 'root' // même si le service n'est pas ajouté dans le tab providers de l'app module, angular nous l'ajoute automatiquement dans le root. // Ts les composants de l'appli peuvent donc l'utiliser via import
})
export class QuickLunchService {
  ...
  getBurgers(): Food[] { // Cette méthode retourne un tableau de food
    return this.burgers;
  }

  getPizzas(): Food[] { // Cette méthode retourne un tableau de food
    return this.pizzas;
  }

  getGalettes(): Food[] { // Cette méthode retourne un tableau de food
